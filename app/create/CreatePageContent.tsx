...
/**
 * Client-side body of the /create route. Split out from `page.tsx` so
 * the page export can be a tiny server component that wraps this in a
 * `<Suspense>` boundary — `useSearchParams()` triggers Next.js's
 * client-side bailout on prerender and the build fails otherwise (the
